...
def process_source_file(source_file, base_name, repetitions):
    ...
    run_script(f"python3 output_examine.py {directory}/output_initial_{base_name}.txt '2024-04-09 12:00:00' '2024-04-10 12:00:00'")
    ...
    for i in range(repetitions):
        ...
        run_script(f"python3 output_examine.py {directory}/output_resilience_{base_name}.txt '2024-04-09 12:00:00' '2024-04-10 12:00:00'")
