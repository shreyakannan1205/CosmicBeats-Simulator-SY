...
def process_source_file(directory, source_file, base_name, repetitions, denied_numbers, labels):
...
def main():
    ...
    for source_file, base_name in source_files:
        process_source_file(directory, source_file, base_name, repetitions, denied_numbers, labels)
